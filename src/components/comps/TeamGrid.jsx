...
export default function TeamGrid() {
  return (
    <div className="w-4/5  text-blue-900 px-8 mr-32 flex justify-center flex-wrap">
      <div className="team-inner-cont w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className=" overflow-hidden h-[10vh]">
          <img className="h-[33vh] ml-[-1.1vh] rounded-t-lg " src={imageOne} /></div>
          <div className="">
        ...
        <GlareCard className="team-mem flex flex-col px-2 justify-center  shadow-lg rounded-lg">
        <div className=" overflow-hidden h-[10vh]">
          <img className=" h-[33vh] ml-[-1.1vh] rounded-t-lg" src={imagetwo} /></div>
        ...
        <GlareCard className="team-mem flex flex-col px-2 justify-center  shadow-lg rounded-lg">
        <div className=" overflow-hidden h-[10vh]"> 
          <img className="h-[33vh] ml-[-1.1vh] rounded-t-lg" src={imagethree} /></div>
        ...
        <GlareCard className="team-mem flex flex-col px-2 justify-center  shadow-lg rounded-lg">
        <div className=" overflow-hidden h-[10vh]">
          <img className="h-[33vh] ml-[-1.1vh] rounded-t-lg " src={imagefour} /></div>
          <div className="p-4">
        ...
        <GlareCard className="team-mem flex flex-col px-2 justify-center  shadow-lg rounded-lg">
        <div className=" overflow-hidden h-[10vh]">
          <img className="h-[33vh] ml-[-1.1vh] rounded-t-lg" src={imagefive} /></div>
